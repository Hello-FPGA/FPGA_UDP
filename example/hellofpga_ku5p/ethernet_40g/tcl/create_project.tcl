create_project -force -part xcku5p-ffvb676-2-i -dir prj udp_40g_loopback
...
set files [list \
	...
	[file normalize "../../../../lib/axis/rtl/axis_fifo_adapter.v"] \
...
source ../IP/clk_wiz_0.tcl
source ../IP/l_ethernet_0.tcl
